...
ffmpeg \
  ...
  [6]scale=1920:1080[s6];[7]scale=1920:1080[s7];[8]scale=1920:1080[s8];[9]scale=1920:1080[s9];[10]scale=1920:1080[s10];[11]scale=1920:1080[s11];
  ...
  [s010][s11]xfade=transition=pixelize:duration=1:offset=99,format=yuv420p" $parameterO
