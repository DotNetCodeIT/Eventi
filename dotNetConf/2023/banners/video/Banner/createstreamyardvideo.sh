...
ffmpeg \
  ...
  -loop 1 -t 7 -i sponsor/sponsor6/sponsor6_1.png \
  -loop 1 -t 7 -i sponsor/sponsor6/sponsor6_2.png \
  ...
  [13]scale=1920:1080[s13];[14]scale=1920:1080[s14];[15]scale=1920:1080[s15];[16]scale=1920:1080[s16];[17]scale=1920:1080[s17];[18]scale=1920:1080[s18];[19]scale=1920:1080[s19];[20]scale=1920:1080[s20];
  ...
  [s09][s10]xfade=transition=pixelize:duration=1:offset=60,format=yuv420p[s10]; \
  [s10][s11]xfade=transition=pixelize:duration=1:offset=66,format=yuv420p[s11]; \
  [s11][s12]xfade=transition=pixelize:duration=1:offset=72,format=yuv420p[s12]; \
  [s12][s13]xfade=transition=pixelize:duration=1:offset=78,format=yuv420p[s13]; \
  [s13][s14]xfade=transition=pixelize:duration=1:offset=84,format=yuv420p[s14]; \
  [s14][s15]xfade=transition=pixelize:duration=1:offset=90,format=yuv420p[s15]; \
  [s15][s16]xfade=transition=pixelize:duration=1:offset=96,format=yuv420p[s16]; \
  [s16][s17]xfade=transition=pixelize:duration=1:offset=102,format=yuv420p[s17]; \
  [s17][s18]xfade=transition=pixelize:duration=1:offset=108,format=yuv420p[s18]; \
  [s18][s19]xfade=transition=pixelize:duration=1:offset=114,format=yuv420p[s19]; \
  [s19][s20]xfade=transition=pixelize:duration=1:offset=120,format=yuv420p" $parameterO